        ...
        {showDetail && selected && (
          ...
          >
            ...
            <div className="fixed bottom-0 left-0 w-full bg-white border-t border-gray-100 p-5 z-20">
              <a 
                href="/api/call"
                className="w-full bg-[#FFD600] text-black font-extrabold py-4 rounded-xl text-[16px] shadow-sm active:scale-95 transition-transform flex justify-center items-center gap-2 block text-center"
              >
