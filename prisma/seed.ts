...
async function main() {
  ...
  const houses = [
    { 
      ...
      rooms: 3, area: 80, floor: 4, totalFloors: 9, buildingType: "Vtorichka", landmark: "Makros supermarketi orqasida", crmId: "5543"
    },
    { 
      lat: 41.31, lng: 69.25, 
      ...
      rooms: 2, area: 65, floor: 2, totalFloors: 4, buildingType: "Vtorichka", landmark: "Minor metrosi", crmId: "1284"
    },
    { 
      lat: 41.28, lng: 69.26, 
      ...
      rooms: 1, area: 42, floor: 7, totalFloors: 12, buildingType: "Novostroyka", landmark: "Yangi Sergeli parki", crmId: "9932"
    },
    { 
      lat: 41.35, lng: 69.30, 
      ...
      rooms: 5, area: 120, floor: 2, totalFloors: 2, buildingType: "Novostroyka", landmark: "Lokomotiv parki", crmId: "1102"
    },
    { 
      lat: 41.26, lng: 69.22, 
      ...
      rooms: 1, area: 38, floor: 9, totalFloors: 16, buildingType: "Novostroyka", landmark: "Bratishka kafesi", crmId: "2031"
    },
    { 
      lat: 41.33, lng: 69.28, 
      ...
      rooms: 3, area: 90, floor: 5, totalFloors: 8, buildingType: "Novostroyka", landmark: "Oybek metrosi", crmId: "8472"
    }
  ]
